function output_txt = myfunction(obj,event_obj,h,zz,zzcell,zzcumulate,xuhao)
...
num = length(handle);
%--------------------------------------
output_txt = {[num2str(num-1),'点'],['Index:',num2str(h.CData(ind))]};

%b = zz; 
%
%查找对应坐标的点号
[m,n]=  find(zz ==h.CData(ind)); 
...
text1 = uicontrol('Style', 'edit', 'String', {['X: ',num2str(pos(1))],...
    ['Y: ',num2str(pos(2))]},...
